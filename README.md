...
You can reply to a Slack message thread by setting `SLACK_THREAD_TS`.

### 1. Using a Slack message URL (webhook mode)
Copy a Slack message link, e.g. `p1695041399000100` → convert to `1695041399.000100`.

```yaml
uses: rtCamp/action-slack-notify@v2
env:
  SLACK_WEBHOOK: ${{ secrets.SLACK_WEBHOOK }}
  SLACK_MESSAGE: "Follow-up message"
  SLACK_THREAD_TS: "1695041399.000100"
